class ReportsController < ApplicationController
  ...
  def index
    ...
    elsif (current_user.role == "qa" || current_user.role == "manager")
  ...
  def report_params
    params.require(:report).permit(:creator_id, :title, :description, :type_Report, :deadline, :image, :developer_id, :status)
  end
end
